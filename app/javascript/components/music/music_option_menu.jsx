...
export default function MusicOptionMenu ({ loggedIn, openModal, musicType, item, fetchUser, sessionId, modalType, closeModal, createListItems, closeModalConfirm }) {
            ...
            </Link>
            {
                lists.map((list, i) => (
                    <label className='list-modal-item' key={i}>
                        ...
                        <input type="checkbox" id={`list${i}`} onChange={() => changeListToAddTo(list.id)} />
