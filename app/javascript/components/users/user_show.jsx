...
export default function UserShow ({ sessionId, fetchUser, entities, openModal, modalType, updateList }) {
    ...
    if (pageNotFound) return <PageNotFound />;
        ...
        <div>
            ...
            {['managePins', 'editProfile', 'changePfp'].includes(modalType) ? <ModalContainer component={modal()} /> : null}
        </div>
    );
}
